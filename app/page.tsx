...
export default function Home() {
  ...
  return (
    <>
      ...
      /> */}
      <main className="z-0 relative text-white gap-8 flex flex-col items-center">
        <Top />
...
function Top() {
  return (
    <div className="relative w-full flex min-h-screen flex-col items-center justify-center gap-6 md:gap-10 border-b border-white/10">
      ...
      <p className="text-[3vw] pb-2 text-center font-semibold leading-snug">
      ...
      <div>
        ...
        <img src="/logos.svg" alt="logos" className="opacity-50 h-[4vmin]" />
      </div>
      <div className="pt-8" />
      <ContactButton />
